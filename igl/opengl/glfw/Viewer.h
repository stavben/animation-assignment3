...
public:
   ...
   // Eigen::Matrix3f GetParentsRotationInverse(int index
    ...
    Eigen::Vector4d spherePosition();
    void printRotation();
    IGL_INLINE void operate_ik(Eigen::Vector3d R, Eigen::Vector3d E, ViewerData* data, Eigen::Vector3d D);
    void CalculateIK();
    Eigen::Matrix3d GetParentsRotationInverse(int index);
    void fabrik_ik();
    bool Fabrik = false;
    IGL_INLINE void operate_fabrik(std::vector<Eigen::Vector3d> pi);
